...
<p align="left">
  ...
  <p align="left">
    ...
    <br />
    <a href="https://www.cometchat.com/docs/vue-v4-uikit/overview"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
Contributions are what make the open-source community such an amazing place to learn, inspire, and create. Any contributions you make are **greatly appreciated**. Sincere thanks to all our [contributors](https://github.com/cometchat-pro/javascript-vue-chat-app/graphs/contributors)!
...
`cometchat-chat-sample-app-vue` is created & maintained by CometChat.
