...
Learn more about how to integrate [UI Kit](https://github.com/cometchat-pro/cometchat-pro-vue-ui-kit/tree/v2) inside your app.
...
This project uses the following [license](https://github.com/cometchat-pro/javascript-vue-chat-app/blob/v2/LICENSE).